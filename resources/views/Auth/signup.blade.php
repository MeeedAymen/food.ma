...
@section('content')
    <form class="bg-gray-200 h-screen pt-[5%]">
        <div class="flex justify-center ">
            <div
                class="flex items-center border border-gray-300 w-full max-w-md px-6 mx-auto lg:w-2/6  rounded-xl bg-white drop-shadow-lg ">
                        ...
                        <form>
                            <div>
                                ...
                                <input type="text" name="firstName" id="firstName" placeholder="First Name"
                                    class="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring">
                            </div>
                            ...
                            <div class="mt-3">
                                <label for="email" class="block mb-2 text-sm text-gray-600">Confirme Email</label>
                                <input type="email" name="email" id="email" placeholder="name@gmail.com"
                                    class="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring">
                            </div>
                            ...
                            <div class="mt-3">
                                ...
                                <input type="email" name="email" id="email" placeholder="Your phone"
                                    class="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring">
                            </div>
                            ...
                            <div class="flex items-center mt-3 space-x-3 flex justify-center">
                                <div class="shrink-0">
                                    <img id='preview_img' class="h-12 w-12 object-cover rounded-full"
                                        src="{{ asset('storage/images/HappyFood.jpg') }}" alt="azza" />
                                </div>
                                <label class="block">
